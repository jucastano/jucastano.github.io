...
<!DOCTYPE html>
<head>
<title>FundraisingATM | Add Fundraiser Member</title>
...
<div id="container">
      ...
      <div id="content" style="margin-left:35px">
          <h1 align="center"><b>Add New Member Account</b></h1>
		<div class="table">
...
<br>
  ...
  <div class="table" style="width:100%; height:390px">
			...
			<div class="simpleTabs" style="margin-left:30px;">
				...
				<div>
					<h1 style="color: #cc0000"><b> [Group] Member Contact Information</b></h1>
							<span style="font-size:14px">Member Title:	<!--<span>[Group] Leader Type: </span> [Group] = same as the selected group above -->
							<select name="">
  ...
  <div class="table" style="width:100%;">
	 ...
	 <div class="table">
	 	<form class="graybackground" action="addFundMember.php" method="POST" enctype="multipart/form-data" id="myForm" name="myForm" onsubmit="return(validate());">
			...
			<h2 style="color: #cc0000"><b>How To Add Multiple Members</b></h2>
			<ol>
